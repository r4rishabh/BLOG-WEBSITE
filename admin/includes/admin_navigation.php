<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php endif; ?>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#post_demo"><i class="fa fa-fw fa-arrows-v"></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="post_demo" class="collapse">
                            <li>
