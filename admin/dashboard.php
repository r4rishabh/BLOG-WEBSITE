    ...
    <div class="col-lg-3 col-md-6">
            ...
            <a href="categories.php">
                ...
                <?php
                   ...
                   $query = "SELECT * FROM posts WHERE post_status = 'published' ";
                    ...
                    $unapproved_comments_counts = mysqli_num_rows($unapproved_comment_query);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comments_counts,$unapproved_comments_counts, $user_counts, $subscriber_counts, $category_counts];
