...
<?php 
    ...
    if(isset($_POST['create_comment'])) {
        ...
        if (!empty($comment_author) && !empty($comment_email) && !empty($comment_content)) {
            ...
            $query = "INSERT INTO comments (comment_post_id, users_id, comment_author, comment_email, comment_content, comment_status,comment_date)";

            $query .= "VALUES ($the_post_id , $cat_user_id, '{$comment_author}', '{$comment_email}', '{$comment_content }', 'unapproved',now())";
